...
\centering \includegraphics[width=\textwidth]{figs/piketty_cage.png} % Replace with your image file         
\end{column}     
\end{columns}
\end{frame}
%
...
\centering\includegraphics[width=0.6\paperwidth]{figs/consumption-function}
\begin{itemize}
...
\begin{frame}{What is a reasonable calibration of such a model?}
\begin{center}
\textbf{\centering\includegraphics[width=7cm]{figs/HA-TargetMeanWealth}}
\par\end{center}
\begin{itemize}
...
%
\begin{frame}{One-asset model with $\beta$-heterogeneity}
\centering\includegraphics[width=7cm]{figs/HA-TargetMeanWealth-beta-het}
\begin{itemize}
