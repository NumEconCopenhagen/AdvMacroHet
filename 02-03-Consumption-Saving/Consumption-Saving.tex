...
\only<1>{\textbf{Every block is a set of equations }mapping inputs into outputs.}
\only<2>{%
...
\includegraphics[width=0.48\textwidth]{figs/pih_vfi_vs_closed} & \includegraphics[width=0.48\textwidth]{figs/pih_vfi_error}\tabularnewline
\end{tabular}
