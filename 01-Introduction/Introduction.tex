...
\begin{itemize}
\item \textbf{Lecture 1-3:} Consumption-saving models
\item \textbf{Lecture 4-6:} General equilibrium model\\
(stationary equilibrium + transition path)
\item \textbf{Lecture 7-8:} Wealth inequality + Secular Stagnation
\item \textbf{Lecture 9-13:} HANK
